...
class TestFCAD(unittest.TestCase):
    ...
    BASE_DOMAIN_DATA = {
        'domain': {
            'objectSid': (ndr_pack(
                security.dom_sid('S-1-5-0-0-0-0-1')), ),
        ...
        'users': {
            'admin': {
                'cn': ('admin', ),
                'objectSid': (ndr_pack(
                    security.dom_sid('S-1-5-0-0-0-0-1001')), ),
            ...
            'guest': {
                'cn': ('guest', ),
                'objectSid': (ndr_pack(
                    security.dom_sid('S-1-5-0-0-0-0-1002')), ),
        ...
        'groups': {
            'admins': {
                'cn': ('admins', ),
                'objectSid': (ndr_pack(
                    security.dom_sid('S-1-5-0-0-0-0-1011')), ),
            ...
            'editors': {
                'cn': ('editors', ),
                'objectSid': (ndr_pack(
                    security.dom_sid('S-1-5-0-0-0-0-1012')), ),
        ...
        'hosts': {
            'client1': {
                'cn': ('client1', ),
                'objectSid': (ndr_pack(
                    security.dom_sid('S-1-5-0-0-0-0-1101')), ),
    ...
    TEST_PROFILE_MOD_DOM_DATA = {
        ...
        'displayName': (b'_FC_Test Profile',),
        'cn': None,
        'objectCategory': ('CN=Group-Policy-Container,CN=Schema,CN=Configuration,DC=FC,DC=AD',),
    ...
    def _get_domain_profile_data(self, cn, template=TEST_PROFILE_DOM_DATA):
        ...
        dom_profile['gPCFileSysPath'] = (dom_profile['gPCFileSysPath'][0] % cn.encode(), )
        return dom_profile        
    ...
    def test_01_save_profile(self):
        ...
        self.assertEqual(
            data['priority'],
            self.TEST_PROFILE['priority'])
        # Check settings
        self.assertEqual(
            data['settings'],
            self.TEST_PROFILE['settings'])
